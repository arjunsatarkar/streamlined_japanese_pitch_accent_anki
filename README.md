...
1. This add-on simply highlights the accented mora, eg. the accent of 柊 displays as <ins><strong>ひ</strong></ins>いらぎ. Flat words display with a flat overline so you don't have to hunt for an accented mora if there aren't any.
